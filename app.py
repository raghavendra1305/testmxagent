...
if not GOOGLE_API_KEY:
    # For development, provide a hardcoded fallback key if the environment variable is not set on a new system.
...
if not MAXIMO_HOST:
    ...
    # This should match the IP address you found for your Maximo server
    # Using https is generally more robust.
    MAXIMO_HOST = "https://10.0.0.1" 
...
# --- Configure Libraries at Startup ---
# This is a more robust pattern than configuring inside each function call.
if API_KEYS.get("google"):
    try:
        genai.configure(api_key=API_KEYS["google"])
        print("✅ Google Generative AI configured successfully for the web application.")
    except Exception as e:
        print(f"❌ ERROR: Failed to configure Google Generative AI: {e}")
else:
    print("❌ WARNING: Google API Key not found. Test Case Agent will not function.")
